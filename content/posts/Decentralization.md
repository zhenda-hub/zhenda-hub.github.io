...
| **区块链编程工具**      | **Truffle**                | 以太坊开发框架，提供编译、测试、部署等功能                        | JavaScript, Solidity                |
|                        | **Hardhat**                | 以太坊开发框架，支持更复杂的开发流程，如自动化测试和合约部署     | JavaScript, Solidity                |
|                        | **Anchor**                 | Solana 开发框架，简化 Rust 智能合约开发，支持高效构建 DApp          | Rust                                |
...
公链: 
智能合约: 自动执行、不可修改的程序         Solidity rust
Dapp: 是通过使用智能合约来与区块链交互     go js
钱包: 用户与公链的交易入口                go js
