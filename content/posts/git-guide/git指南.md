...
| 格式     | 特点                           | 压缩方式  | 音质   | 文件大小 | 兼容性   | 是否含有音频对应文字 |
| -------- | ------------------------------ | --------- | ------ | -------- | -------- | --------------------- |
| **MP3**  | 广泛流行，高压缩比             | 有损      | 中至高 | 小       | 高       | 否（需外部LRC文件）  |
| **AAC**  | MP3的继任者，音质更好          | 有损      | 高     | 较小     | 中至高   | 否（需外部文件）     |
| **OGG**  | 开放源代码，音质良好           | 有损      | 中至高 | 小       | 中       | 否（需外部文件）     |
...
| **M4A**  | 基于MP4容器，常用AAC编码       | 无损/有损 | 高     | 较小     | 中至高   | 是（可包含字幕）     |
| **PCM**  | 专业音频处理、原始音频数据存储 | 无压缩    | 最高   | 最大     | 专用设备 | 否（需外部文件）     |

## 视频


| 格式      | 特点                           | 压缩方式  | 视频质量 | 文件大小 | 兼容性 | 是否含有音频对应文字 |
| --------- | ------------------------------ | --------- | -------- | -------- | ------ | --------------------- |
| **MP4**   | 广泛使用，支持多种编码         | 有损      | 高       | 较小     | 高     | 是                     |
| **WMV**   | 微软开发，适合流媒体           | 有损      | 中至高   | 小       | 中     | 是                     |
...
| **MKV**   | 开放标准，支持多音轨和字幕     | 无损/有损 | 高       | 中等     | 中     | 是                     |
| **MOV**   | 苹果开发，高质量视频           | 无损/有损 | 高       | 大       | 中     | 是                     |
| **AVI**   | 微软开发，兼容性强             | 无损/有损 | 高       | 大       | 高     | 否（需外部文件）       |
